...
static const uint8_t move_test[] = {
    ...
    0x00, 0x00, 0x00, 0x10,   /* Reset: PC = 0x00000010 (vector 1) */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  /* Padding */
    0x22, 0x00,               /* 0x10: MOVE.L D0, D1 */
    0x24, 0x01,               /* 0x12: MOVE.L D1, D2 */
    0x4E, 0x71,               /* 0x14: NOP */
...
static const uint8_t move_mem_test[] = {
    ...
    0x2E, 0x80,               /* 0x12: MOVE.L D0, (A7) - store to 0x1000 */
    0x22, 0x17,               /* 0x14: MOVE.L (A7), D1 - load from 0x1000 */
    0x4E, 0x71,               /* 0x16: NOP */
...
static const uint8_t move_b_mem_test[] = {
    ...
    0x1E, 0x80,               /* 0x12: MOVE.B D0, (A7) */
    0x12, 0x17,               /* 0x14: MOVE.B (A7), D1 */
    0x4E, 0x71,               /* 0x16: NOP */
    0x60, 0xFC,               /* 0x18: BRA.S -4 (loop) */
};
...
static const uint8_t move_w_mem_test[] = {
    ...
    0x3E, 0x80,               /* 0x12: MOVE.W D0, (A7) */
    0x32, 0x17,               /* 0x14: MOVE.W (A7), D1 */
    0x4E, 0x71,               /* 0x16: NOP */
    0x60, 0xFC,               /* 0x18: BRA.S -4 (loop) */
};
...
static const uint8_t move_imm_mem_test[] = {
    ...
    0x00, 0x00, 0x00, 0x10,   /* Reset: PC = 0x00000010 (vector 1) */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  /* Padding */
    0x2E, 0xBC, 0xDE, 0xAD, 0xBE, 0xEF,   /* 0x10: MOVE.L #0xDEADBEEF, (A7) */
    0x22, 0x17,               /* 0x16: MOVE.L (A7), D1 */
    0x4E, 0x71,               /* 0x18: NOP */
...
static const uint8_t move_anp_test[] = {
    ...
    0x00, 0x00, 0x00, 0x10,   /* Reset: PC = 0x00000010 (vector 1) */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  /* Padding */
    0x2E, 0xBC, 0x12, 0x34, 0x56, 0x78,   /* 0x10: MOVE.L #0x12345678, (A7) - store at 0x1000 */
    0x22, 0x1F,               /* 0x16: MOVE.L (A7)+, D1 - load from 0x1000, A7 becomes 0x1004 */
    0x4E, 0x71,               /* 0x18: NOP */
    0x60, 0xFC,               /* 0x1A: BRA.S -4 (loop) */
};
...
static const uint8_t move_disp_test[] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  /* Padding */
    0x20, 0x3C, 0x12, 0x34, 0x56, 0x78,   /* 0x10: MOVE.L #0x12345678, D0 */
    0x2F, 0x40, 0x00, 0x04,   /* 0x16: MOVE.L D0, 4(A7) - store at 0x1004 */
    0x22, 0x2F, 0x00, 0x04,   /* 0x1A: MOVE.L 4(A7), D1 - load from 0x1004 */
    0x4E, 0x71,               /* 0x1E: NOP */
...
static const uint8_t add_idx_test[] = {
    0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x10,  /* SP, PC */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x2E, 0xBC, 0x00, 0x00, 0x00, 0x2A,   /* 0x10: MOVE.L #42, (A7) - store at 0x1000 */
...
static const uint8_t sub_idx_test[] = {
    0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x10,  /* SP, PC */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x2E, 0xBC, 0x00, 0x00, 0x00, 0x32,   /* 0x10: MOVE.L #50, (A7) */
    0x70, 0x00,               /* 0x16: MOVEQ #0, D0 */
...
static const uint8_t cmp_idx_test[] = {
    0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x10,  /* SP, PC */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x2E, 0xBC, 0x00, 0x00, 0x00, 0x0A,   /* 0x10: MOVE.L #10, (A7) */
    0x70, 0x00,               /* 0x16: MOVEQ #0, D0 */
...
static const uint8_t rol_reg_test[] = {
    ...
    0xE5, 0x98,               /* 0x16: ROL.L #2, D0 (0xE598: count=2, left, long, ROL) */
    0x4E, 0x71, 0x60, 0xFC,
};
...
static const uint8_t asl_mem_test[] = {
    0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x10,  /* SP, PC */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x20, 0x7C, 0x00, 0x00, 0x10, 0x00,   /* 0x10: MOVEA.L #0x1000, A0 */
    0x30, 0xBC, 0x40, 0x00,               /* 0x16: MOVE.W #0x4000, (A0) */
...
static const uint8_t mulu_test[] = {
    0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x10,  /* SP, PC */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x3E, 0xBC, 0x01, 0x00,               /* 0x10: MOVE.W #0x100, (A7) */
    0x22, 0x3C, 0x00, 0x00, 0x01, 0x00,   /* 0x14: MOVE.L #0x100, D1 */
...
static const uint8_t div_by_zero_test[] = {
    ...
    0x2E, 0x80,               /* 0x18: MOVE.L D0, (A7) - store 0 at 0x1000 (D0=0 from reset) */
    ...
    0x24, 0x3C, 0x00, 0x00, 0xDE, 0xAD,   /* MOVE.L #0xDEAD, D2 */
    0x4E, 0x73,               /* RTE */
};
...
static const uint8_t dbcc_test[] = {
    ...
    0x51, 0xC8, 0xFF, 0xFC,   /* 0x16: DBRA D0, -4 - loop back to ADDQ at 0x14 */
    0x4E, 0x71, 0x60, 0xFC,
};
...
static const uint8_t link_unlk_test[] = {
    0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x10,  /* SP, PC */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x2C, 0x4F,               /* MOVEA.L A7, A6 - save SP in A6 */
...
static const uint8_t eor_test[] = {
    ...
    0x1E, 0x80,               /* MOVE.B D0, (A7) - store 0xFF at 0x1000 */
    0x70, 0x0F,               /* MOVEQ #15, D0 */
    0xB1, 0x17,               /* EOR.B D0, (A7) - opmode 100 in bits 8-6 */
    0x12, 0x17,               /* MOVE.B (A7), D1 - verify */
    0x4E, 0x71, 0x60, 0xFC,
};
...
static const uint8_t move_b_imm_an_test[] = {
    0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x10,  /* SP, PC */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x1E, 0xBC, 0x00, 0xAB,   /* MOVE.B #0xAB, (A7) */
    0x12, 0x17,               /* MOVE.B (A7), D1 - verify */
    0x4E, 0x71, 0x60, 0xFC,
};
...
static const uint8_t move_b_pdec_dn_test[] = {
    0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x10,  /* SP, PC */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x2F, 0x7C, 0x12, 0x34, 0xAB, 0x78, 0xFF, 0xFC,   /* MOVE.L #0x1234AB78, -4(A7) */
    0x12, 0x27,               /* MOVE.B -(A7), D1 */
    0x4E, 0x71, 0x60, 0xFC,
};
...
static const uint8_t move_b_dn_anp_test[] = {
    ...
    0x1E, 0xC0,               /* MOVE.B D0, (A7)+ */
    0x12, 0x2F, 0xFF, 0xFE,   /* MOVE.B -2(A7), D1 */
    0x4E, 0x71, 0x60, 0xFC,
};
...
static const uint8_t move_b_dn_pdec_test[] = {
    ...
    0x12, 0x2F, 0x00, 0x00,   /* MOVE.B 0(A7), D1 */
    0x4E, 0x71, 0x60, 0xFC,
};
...
static const uint8_t move_b_disp_dn_test[] = {
    0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x10,  /* SP, PC */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x2F, 0x7C, 0xAB, 0x12, 0x34, 0x56, 0x00, 0x04,   /* MOVE.L #0xAB123456, 4(A7) */
    0x12, 0x2F, 0x00, 0x04,   /* MOVE.B 4(A7), D1 */
    0x4E, 0x71, 0x60, 0xFC,
};
...
static const uint8_t move_b_dn_disp_test[] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x70, 0xAB,               /* MOVEQ #0xAB, D0 */
    0x1F, 0x40, 0x00, 0x04,   /* MOVE.B D0, 4(A7) */
    0x12, 0x2F, 0x00, 0x04,   /* MOVE.B 4(A7), D1 */
    0x4E, 0x71, 0x60, 0xFC,
};
...
static const uint8_t move_w_imm_an_test[] = {
    0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x10,  /* SP, PC */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x3E, 0xBC, 0x12, 0x34,   /* MOVE.W #0x1234, (A7) */
    0x32, 0x17,               /* MOVE.W (A7), D1 */
    0x4E, 0x71, 0x60, 0xFC,
};
...
static const uint8_t move_w_pdec_dn_test[] = {
    0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x10,  /* SP, PC */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x2F, 0x7C, 0x12, 0x34, 0x12, 0x34, 0xFF, 0xFC,   /* MOVE.L #0x12341234, -4(A7) */
    0x32, 0x27,               /* MOVE.W -(A7), D1 */
    0x4E, 0x71, 0x60, 0xFC,
};
...
static const uint8_t move_w_dn_anp_test[] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x30, 0x3C, 0x12, 0x34,   /* MOVE.W #0x1234, D0 */
    0x3E, 0xC0,               /* MOVE.W D0, (A7)+ */
    0x32, 0x2F, 0xFF, 0xFE,   /* MOVE.W -2(A7), D1 */
    0x4E, 0x71, 0x60, 0xFC,
};
...
static const uint8_t move_w_dn_pdec_test[] = {
    ...
    0x32, 0x2F, 0x00, 0x00,   /* MOVE.W 0(A7), D1 */
    0x4E, 0x71, 0x60, 0xFC,
};
...
static const uint8_t move_w_disp_dn_test[] = {
    0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x10,  /* SP, PC */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x2F, 0x7C, 0x12, 0x34, 0x56, 0x78, 0x00, 0x04,   /* MOVE.L #0x12345678, 4(A7) */
    0x32, 0x2F, 0x00, 0x04,   /* MOVE.W 4(A7), D1 */
    0x4E, 0x71, 0x60, 0xFC,
};
...
static const uint8_t move_w_dn_disp_test[] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x30, 0x3C, 0x12, 0x34,   /* MOVE.W #0x1234, D0 */
    0x3F, 0x40, 0x00, 0x04,   /* MOVE.W D0, 4(A7) */
    0x32, 0x2F, 0x00, 0x04,   /* MOVE.W 4(A7), D1 */
    0x4E, 0x71, 0x60, 0xFC,
};
...
static const uint8_t move_l_imm_disp_test[] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x2F, 0x7C, 0x12, 0x34, 0x56, 0x78, 0x00, 0x04,   /* MOVE.L #0x12345678, 4(A7) */
    0x22, 0x2F, 0x00, 0x04,   /* MOVE.L 4(A7), D1 */
    0x4E, 0x71, 0x60, 0xFC,
};
...
static const uint8_t move_l_pdec_dn_test[] = {
    0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x10,  /* SP, PC */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x2F, 0x7C, 0x12, 0x34, 0x56, 0x78, 0xFF, 0xFC,   /* MOVE.L #0x12345678, -4(A7) -> 0xFFC */
    0x22, 0x27,               /* MOVE.L -(A7), D1 */
    0x4E, 0x71, 0x60, 0xFC,
};
...
static const uint8_t addr_err_test[] = {
    ...
    0x24, 0x3C, 0x00, 0x00, 0x00, 0xAE,   /* MOVE.L #0xAE, D2 (address error marker) */
...
static const uint8_t illegal_test[] = {
    ...
    0x24, 0x3C, 0x00, 0x00, 0x00, 0x04,   /* MOVE.L #4, D2 (illegal marker) */
    0x60, 0xFE,               /* BRA.S -2 (loop) */
};
...
static const uint8_t jmp_test[] = {
    0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x10,  /* SP, PC */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x20, 0x7C, 0x00, 0x00, 0x00, 0x20,   /* 0x10: MOVEA.L #0x20, A0 */
...
/* TRAPV: ORI #0x02, CCR sets V; TRAPV takes vector 7; handler at 0x32 sets D2=7 */
...
static const uint8_t pea_test[] = {
    ...
    0x22, 0x1F,               /* MOVE.L (A7)+, D1 - pop into D1 */
    0x4E, 0x71, 0x60, 0xFC,
};
...
static const uint8_t rol_mem_test[] = {
    ...
    0x30, 0xBC, 0x80, 0x00,               /* MOVE.W #0x8000, (A0) */
    0xE7, 0xD0,               /* ROL.W (A0) - 0xE7D0: ROL left, 0x8000->0x0001 */
...
static const uint8_t btst_an_test[] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x30, 0x7C, 0x01, 0x00,   /* 0x10: movea.w #0x100,a0 */
    0x10, 0xBC, 0x00, 0x81,   /* 0x14: move.b #0x81,(a0) */
...
/* Trace mode test: set T bit in SR, execute NOP, verify trace exception fires (vector 9) */
static const uint8_t trace_mode_test[] = {
    0x00, 0x00, 0x10, 0x00,   /* 0x00: SP = 0x1000 */
    0x00, 0x00, 0x00, 0x30,   /* 0x04: PC = 0x30 */
    0x00, 0x00, 0x00, 0x00,   /* 0x08: Vector 2 */
    0x00, 0x00, 0x00, 0x00,   /* 0x0C: Vector 3 */
    0x00, 0x00, 0x00, 0x00,   /* 0x10: Vector 4 */
    0x00, 0x00, 0x00, 0x00,   /* 0x14: Vector 5 */
    0x00, 0x00, 0x00, 0x00,   /* 0x18: Vector 6 */
    0x00, 0x00, 0x00, 0x00,   /* 0x1C: Vector 7 */
    0x00, 0x00, 0x00, 0x00,   /* 0x20: Vector 8 */
    0x00, 0x00, 0x00, 0x3C,   /* 0x24: Vector 9 (trace) = handler at 0x3C */
    0x00, 0x00, 0x00, 0x00,   /* 0x28: Vector 10 */
    0x00, 0x00, 0x00, 0x00,   /* 0x2C: Vector 11 */
    /* 0x30: Code */
    0x46, 0xFC, 0xA7, 0x00,   /* MOVE.W #0xA700, SR (T=1, S=1, I=7) */
    0x4E, 0x71,               /* NOP (trace fires after this) */
    0x4E, 0x71,               /* NOP (not reached) */
    0x60, 0xFE,               /* BRA.S -2 */
    0x00, 0x00,               /* padding to 0x3C */
    /* 0x3C: Trace handler */
    0x74, 0x09,               /* MOVEQ #9, D2 */
    0x60, 0xFE,               /* BRA.S -2 (loop) */
};

/* Nested exception: TRAP #0 handler triggers TRAP #1; both return via RTE */
static const uint8_t nested_exception_test[] = {
    0x00, 0x00, 0x10, 0x00,   /* 0x00: SP = 0x1000 */
    0x00, 0x00, 0x00, 0x88,   /* 0x04: PC = 0x88 */
    /* Vectors 2-31: zeros */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    /* 0x80: Vector 32 (TRAP #0) = handler at 0x90 */
    0x00, 0x00, 0x00, 0x90,
    /* 0x84: Vector 33 (TRAP #1) = handler at 0x98 */
    0x00, 0x00, 0x00, 0x98,
    /* 0x88: Main code */
    0x4E, 0x40,               /* TRAP #0 */
    0x4E, 0x71,               /* NOP (returned here after nested exceptions) */
    0x60, 0xFE,               /* BRA.S -2 */
    0x00, 0x00,               /* padding */
    /* 0x90: TRAP #0 handler */
    0x4E, 0x41,               /* TRAP #1 (nested exception!) */
    0x76, 0x58,               /* MOVEQ #88, D3 */
    0x4E, 0x73,               /* RTE */
    0x00, 0x00,               /* padding */
    /* 0x98: TRAP #1 handler */
...
/* Phase 4 smoke test: nested BSR, MOVEM save/restore, arithmetic, self-modifying code */
static const uint8_t smoke_test[] = {
    0x00, 0x00, 0x10, 0x00,   /* 0x00: SP = 0x1000 */
    0x00, 0x00, 0x00, 0x10,   /* 0x04: PC = 0x10 */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  /* vectors 2-3 */
    /* 0x10: Main code */
    0x70, 0x0A,               /* MOVEQ #10, D0 */
    0x72, 0x14,               /* MOVEQ #20, D1 */
    0x74, 0x1E,               /* MOVEQ #30, D2 */
    0x76, 0x28,               /* MOVEQ #40, D3 */
    0x61, 0x14,               /* BSR.S +20 → subroutine at 0x2E */
    /* Self-modifying code: write MOVEQ #77,D6 + RTS to 0x200, then JSR there */
    0x31, 0xFC, 0x7C, 0x4D, 0x02, 0x00,   /* MOVE.W #0x7C4D, (0x200).W */
    0x31, 0xFC, 0x4E, 0x75, 0x02, 0x02,   /* MOVE.W #0x4E75, (0x202).W */
    0x4E, 0xB8, 0x02, 0x00,               /* JSR (0x200).W */
    0x4E, 0x71,               /* NOP */
    0x60, 0xFE,               /* BRA.S -2 (loop) */
    /* 0x2E: Subroutine - MOVEM save, compute sum, MOVEM restore */
    0x48, 0xE7, 0xF0, 0x00,   /* MOVEM.L D0-D3, -(A7) */
    0xD0, 0x81,               /* ADD.L D1, D0 (D0=30) */
    0xD0, 0x82,               /* ADD.L D2, D0 (D0=60) */
    0xD0, 0x83,               /* ADD.L D3, D0 (D0=100) */
    0x28, 0x00,               /* MOVE.L D0, D4 */
    0x7A, 0x2A,               /* MOVEQ #42, D5 */
    0x4C, 0xDF, 0x00, 0x0F,   /* MOVEM.L (A7)+, D0-D3 */
    0x4E, 0x75,               /* RTS */
};
...
static int check_test_result(size_t idx)
{
    ...
    case 111: return cpu.d[2] == 9;                                              /* trace_mode: D2=9 from trace handler */
    case 112: return cpu.d[2] == 99 && cpu.d[3] == 88;                           /* nested_exception: D2=99, D3=88 */
